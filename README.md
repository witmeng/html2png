...
-   **Output Directory**: All images generated by the service, or by the CLI if no specific output path outside this directory is given, are saved into the `output_images` directory.
